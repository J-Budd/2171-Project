...
public class StudentManager {
    ...
    public static void updateStudent(String oldFirstName, String oldLastName, String newFirstName, String newLastName,
                                     String newBirthdate, String newAddress, String newGuardian, String newRegularContact,
                                     String newEmergencyContact) {
        StudentRecord student = findStudent(oldFirstName, oldLastName);
        if (student != null) {
            student.updateStudent(newFirstName, newLastName, newBirthdate, newAddress, newGuardian, newRegularContact, newEmergencyContact);
        } else {
